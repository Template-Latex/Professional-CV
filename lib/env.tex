...
\newenvironment{institutionicon}[4][]{%
	\ifthenelse{\equal{\institutioniconsize}{small}}{%
		\global\def\GLOBALinstitutionicon {\raisebox{-0.01\baselineskip}{\includegraphics[height=0.65\baselineskip]{#4}}\hspace{0.45em}}
	}{
	\ifthenelse{\equal{\institutioniconsize}{normal}}{%
		\global\def\GLOBALinstitutionicon {\raisebox{-0.15\baselineskip}{\includegraphics[height=1\baselineskip]{#4}}\hspace{0.45em}}
	}{
	\ifthenelse{\equal{\institutioniconsize}{large}}{%
		\global\def\GLOBALinstitutionicon {\raisebox{-0.25\baselineskip}{\includegraphics[height=1.25\baselineskip]{#4}}\hspace{0.65em}}
	}{
