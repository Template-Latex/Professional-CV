...
%	#3	Contenido
%	#4	Contenido a reemplazar en caso de fallar espaciado (requiere tipo "replace")
\newcommand{\printifspace}[4][replace]{%
	...
	\ifthenelse{\printspaceboxheight<\measurepage}{%
		...
		\ifthenelse{\equal{#1}{replace}}{ % Reemplaza
			#4%
		}{%
		...
		\ifthenelse{\equal{#1}{i}}{ % Nueva página
			...
			\throwwarning{Valor paging incorrecto, validos: replace, np, i}%
		}}}%
	}%
}
