...
\newcommand{\institutionentry}[4]{%
	\newinstitutionentry{#1}{#2 }{ #3}{\dateseparator}{.68999\linewidth}{.31\linewidth}{#4}%
}
...
\newcommand{\institutionentryshort}[4]{%
	\newinstitutionentry{#1}{#2 }{ #3}{\dateseparator}{.85999\linewidth}{.14\linewidth}{#4}%
}
...
\newenvironment{institution}[3][]{%
	...
	\begin{indentsection}%
		...
		\ifx\hfuzz#3\hfuzz
			...
			\end{minipage}
		\else
			\begin{minipage}{.55999\linewidth}
				\ifx\hfuzz#1\hfuzz
				\textscale{1.1}{\textcolor{\linkcolor}{#2}}
				\else
				\textscale{1.1}{\href{#1}{#2}}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={2.2.0-4},
		Template.Version.Hash={129976D2E138F02809C7745B93007811},
