...
\newcommand{\printifspace}[4][np]{%
	...
	\ifthenelse{\printspaceboxheight<\measurepage}{%
		...
		\ifthenelse{\equal{#1}{r}}{ % Reemplaza (fallo)
			#4%
		}{%
		\ifthenelse{\equal{#1}{np}}{ % Lo inserta pero con una nueva página (fallo)
			\printifspacefill%
			\newpage#3%
		}{%
		\ifthenelse{\equal{#1}{i}}{ % Nueva página (fallo)
			\printifspacefill%
			\newpage%
		}{%
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.0.0-2},
		Template.Version.Hash={9D383F92CD914B2C3D8941190D305196},
	...
	pdfproducer={Professional-CV v4.0.0 | (Pablo Pizarro R.) ppizarror.com},
