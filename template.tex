...
\newcommand{\newinstitutionentry}[5]{%
	...
	\begin{indentsectiondouble}%
		...
		\ifthenelse{\equal{#5}{}}{%
			...
			\ifthenelse{\institutionentrytitle<\dimexpr0.95\linewidth}{ % Título en una sola línea
				\def\LOCALinstitutionentryreqspace {2}%
			}{%
				\def\LOCALinstitutionentryreqspace {3}%
			}%
		}%
		\printifspace{\LOCALinstitutionentryreqspace}{%
			\begin{minipage}{1\linewidth} % Crea el título
				\ifthenelse{\institutionentrytitle<\dimexpr0.95\linewidth}{ % Una sola línea
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={3.3.4},
		Template.Version.Hash={963CA7A74B71ED3D5511363CCDEECCEE},
	...
	pdfproducer={Professional-CV v3.3.4 | (Pablo Pizarro R.) ppizarror.com},
...
% Ejecuta al terminar el documento
\AtEndDocument{%
	\vfill%
}
