...
\newcommand{\otherentry}[2]{%
	...
	\end{basedescript}
	\global\def\GLOBALcvfinishlist {true}%
}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={3.0.3-5},
		Template.Version.Hash={3D80DD42E43E9E07215372779A610E89},
	...
	pdfproducer={Professional-CV v3.0.3 | (Pablo Pizarro R.) ppizarror.com},
...
% Configura items
\AfterEndEnvironment{itemize}{\global\def\GLOBALcvfinishlist {true}}
\AfterEndEnvironment{enumerate}{\global\def\GLOBALcvfinishlist {true}}
