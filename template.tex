...
\newcounter{headerseparatorsticky}
\newcounter{headerseparatorstickyhs}
...
% Agrega un enlace al header con ícono
...
\newcommand{\addheaderlink}[2][]{%
	\ifthenelse{\equal{#1}{}}{%
		...
		\ifnum\value{headerseparatorsticky}>0%
			\ifnum\value{headerseparatorstickyhs}>0%
				\addheaderspace{\headericonhmargin cm}%
			\fi%
		\fi%
		\addheaderurl[\unexpanded{\faIcon{#1}}]{#2}%
		\stepcounter{headerseparatorsticky}%
		\stepcounter{headerseparatorstickyhs}%
	}%
}
...
\newcommand{\addheaderurl}[2][]{%
	\ifthenelse{\equal{#1}{}}{%
		...
		\addheaderseparator[i]%
		\immediate\write\fileheaderitems{\unexpanded{\href{#2}{#1}}\LOCALpercentchar}%
	}%
}
...
\newcommand{\writeheader}{%
	...
	\hypersetup{filecolor=\headerurlcolor, linkcolor=\headerurlcolor, urlcolor=\headerurlcolor}%
	...
	\vspace{0.55em}%
	\hypersetup{filecolor=\urlcolor, linkcolor=\urlcolor, urlcolor=\urlcolor}%
}
	...
	\begin{institutionindent}%
		...
		\begin{institutionindent}%
			...
			\ifthenelse{\equal{#5}{}}{%
				...
				\printifspace[r]{3}{%
					\vspace{\institutionbotmargin\baselineskip}%
				}{}%
			}%
		\end{institutionindent}%
	\end{institutionindent}%
